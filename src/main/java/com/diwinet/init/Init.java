...
class Init {
	...
	public static void main(String []args) throws Exception {
		...
		String user = cache.getString("mqtt.user");
		String password = cache.getString("mqtt.password");
		String host = cache.getString("mqtt.host");
		int port = new Integer(cache.getString("mqtt.port")).intValue();
		final String destination = cache.getString("mqtt.topic");
		boolean flag = true;
...
//		mqtt.setClientId("clienteqwe312");
		...
		connection.listener(new DataHandlerListener());
