...
public class HttpClientUtils {
	 ...
	 * 读取数据超时时间
	 */
	public static final int SO_TIMEOUT_MS = 2000;
	...
	public static String simpleGetInvoke(String url, Map<String, String> params)
		...
		return simpleGetInvoke(url, params,CONTENT_CHARSET_GBK);
	}
	/**
	 * 简单get调用
	 * 
	...
	public static String simplePostInvoke(String url, Map<String, String> params)
		...
		return simplePostInvoke(url, params,CONTENT_CHARSET_GBK);
	}
	/**
	 * 简单post调用
	 * 
	...
	public static String simplePostInvoke(String url, Map<String, String> params,String charset)
		...
		HttpPost postMethod = buildHttpPost(url, params,GBK);
	...
	public static void setCommonHttpMethod(HttpRequestBase httpMethod) {
		httpMethod.setHeader(HTTP.CONTENT_ENCODING, CONTENT_CHARSET_GBK);// setting
		// contextCoding
	...
	static	void assertStatus(HttpResponse res) throws IOException{
		...
		case HttpStatus.SC_OK:
			...
			break;
		default:
			logger.info("返回状态:"+res.getStatusLine().getStatusCode()+",调用内部命令下发服务失败");
		}
	}
	...
	public static void main(String[] args) throws ClientProtocolException, IOException, URISyntaxException {
		...
		map.put("cmd", "123");
		map.put("lxdh", "1064838703000");
//		System.out.println(simplePostInvoke("http://101.201.104.132/sms/sendCommand.p",map));
		System.out.println(simplePostInvoke("http://101.201.104.132/sms/sendCommand.p",map));
	}
}